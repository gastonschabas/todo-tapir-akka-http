...
lazy val openAPICirceYamlVersion = "0.7.4"
...
lazy val flywayVersion = "10.7.1"
lazy val scalaTestVersion = "3.2.18"
lazy val slickVersion = "3.4.1"
lazy val kamonVersion = "2.7.0"
lazy val testcontainersScalaVersion = "0.41.2"
...
lazy val endpoints = (project in file("todo-endpoints")).settings(
  ...
  libraryDependencies := Seq(
    ...
    "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.28.1",
