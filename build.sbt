...
lazy val tapirVersion = "1.9.5"
lazy val openAPICirceYamlVersion = "0.7.3"
...
lazy val postgreSqlDriverVersion = "42.7.1"
lazy val flywayVersion = "10.3.0"
lazy val scalaTestVersion = "3.2.17"
lazy val slickVersion = "3.4.1"
lazy val kamonVersion = "2.7.0"
...
lazy val endpoints = (project in file("todo-endpoints")).settings(
  ...
  libraryDependencies := Seq(
    ...
    "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "2.26.0",
    "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.26.0"
  )
)
